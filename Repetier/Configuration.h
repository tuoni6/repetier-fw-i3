...
*/
#define DRIVE_SYSTEM 0  //Delta Rostock MAX
...
#define MICRO_STEPS 8          // RAMBo 1.0 and earlier use 8 (1/8 stepping), 1.1 and on uses 16 (1/16 stepping) RAMPS and Pololu drivers are normally 16
...
#define ZAXIS_STEPS_PER_MM 3992.00
#endif
...
//  Overridden if EEPROM activated.
#define EXT0_MAX_START_FEEDRATE 35
// Acceleration in mm/s^2
//  Overridden if EEPROM activated.
#define EXT0_MAX_ACCELERATION 40
...
#define USER_THERMISTORTABLE0  {\
  {47*4,250*8},{51*4,245*8},{55*4,240*8},{60*4,235*8},{65*4,230*8},{71*4,225*8},{77*4,220*8},{84*4,215*8},{91*4,210*8},{100*4,205*8},\
  {109*4,200*8},{119*4,195*8},{130*4,190*8},{142*4,185*8},{155*4,180*8},{170*4,175*8},{186*4,170*8},{204*4,165*8},{223*4,160*8},\
  {244*4,155*8},{267*4,150*8},{291*4,145*8},{318*4,140*8},{347*4,135*8},{377*4,130*8},{409*4,125*8},{443*4,120*8},{478*4,115*8},\
  {514*4,110*8},{552*4,105*8},{589*4,100*8},{627*4,95*8},{664*4,90*8},{701*4,85*8},{736*4,80*8},{769*4,75*8},{801*4,70*8},{830*4,65*8},\
  {857*4,60*8},{882*4,55*8},{904*4,50*8},{923*4,45*8},{940*4,40*8},{955*4,35*8},{967*4,30*8},{978*4,25*8},{987*4,20*8},{995*4,15*8},\
  {1001*4,10*8},{1006*4,5*8},{1010*4,0*8}	}
...
#define Z_MAX_LENGTH 180  // Set this to your appx maximum Z height from home position to table measred from the nozzle tip.  You can fine-tune this with either the endstop screws or eeprom settings in Repetier Host
...
/** Maximum feedrate, the system allows. Higher feedrates are reduced to these values.
    The axis order in all axis related arrays is X, Y, Z
     Overridden if EEPROM activated.
    */
#define MAX_FEEDRATE_X 275
#define MAX_FEEDRATE_Y 275
...
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_X 1080
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Y 1080
...
#define UI_VERSION_STRING2 "Prusa I3"
